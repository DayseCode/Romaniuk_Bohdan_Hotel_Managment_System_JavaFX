...
public class ManagerCheckOutDetails implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        // Встановлення фабрики значень для кожного стовпця таблиці
        ...
        // Відображення даних у таблиці Check-in/Check-out
        showCheckInOutInfo();

        // Додавання кнопки для завантаження квитанції у кожний рядок таблиці
        slipDownloadBtn();
    }

    // Метод для відображення інформації про Check-in/Check-out
    ...
    // Метод для додавання кнопки для завантаження квитанції
                        ...
                        TableCell<ManagerCheckOutTable, String> cell = new TableCell<ManagerCheckOutTable, String>() {
                            ...
                            protected void updateItem(String item, boolean empty) {
                                ...
                                if (empty) {
                                    ...
                                    // Встановлення стилів та обробників подій для іконки завантаження
                                    ...
                                    downloadIcon.setOnMouseClicked((MouseEvent event2) -> {
                                        ...
                                        // Ваша логіка для генерації та завантаження PDF-квитанції
