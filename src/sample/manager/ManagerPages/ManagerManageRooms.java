...
public class ManagerManageRooms extends DBConnection implements Initializable {
    ...
    public void addRoom(ActionEvent actionEvent) throws SQLException {
        // Додавання інформації про кімнату до бази даних
    ...
    public void initialize(URL location, ResourceBundle resources) {
        // Ініціалізація випадаючого списку та таблиці
        ...
        price_DayCol.setCellValueFactory(new PropertyValueFactory<>("PRICEDAY"));
        roomStatusCol.setCellValueFactory(new PropertyValueFactory<>("STATUS"));

        // Завантаження таблиці кімнат
        showRoomTable();

        // Додавання кнопок "Редагувати" та "Видалити" до таблиці
        actionButtons();
    }

    public void showRoomTable() {
        // Очищення списку та завантаження даних про кімнати
        TABLEROW.clear();
        Connection connection = getConnections();
        try {
                        ...
                        TableCell<ManagerRoomTable, String> cell = new TableCell<ManagerRoomTable, String>() {
                            ...
                            protected void updateItem(String item, boolean empty) {
                                ...
                                if (empty) {
                                    ...
                                    // Обробник події для видалення запису
                                    ...
                                    // Відображення іконки редагування
                                    editIcon.setStyle(
                                            " -fx-cursor: hand ;"
                                                    + "-glyph-size:20px;"
                                                    + "-fx-fill:#ffffff;"
                                    ...
                                    // Обробник події для редагування запису
    ...
    public void tableRowDelete(ManagerRoomTable managerRoomTable) {
        // Видалення запису про кімнату з бази даних
        ...
        if (!roomStatus.equals("Booked")) {
            ...
            try {
                if (!connection.isClosed()) {
                    ...
                    CommonTask.showAlert(Alert.AlertType.INFORMATION, "Delete Operation Successful", "Room No " + managerRoomTable.getROOMNO() + " is deleted from the database!");
    ...
    public void editTableRowInfo(ManagerRoomTable managerRoomTable) throws IOException {
        // Редагування запису про кімнату
        if (!(managerRoomTable.getSTATUS()).equals("Booked")) {
            ...
            try {
                if (!connection.isClosed()) {
                    ...
                    // Отримання контролера вікна редагування
    ...
    public void stagePosition(Stage primaryStage, Parent root) {
        // Налаштування можливості перетягування вікна
