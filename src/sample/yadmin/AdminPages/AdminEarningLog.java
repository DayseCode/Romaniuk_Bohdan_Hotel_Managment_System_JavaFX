...
public class AdminEarningLog implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        // Встановлення значень для відповідних стовпців у таблиці з використанням даних з класу AdminEarningTable
    ...
    // Метод для відображення журналу прибутку
    public void showEarningLog(){
        TABLEROW.clear();
        Connection connection = getConnections();
        try {
            if(!connection.isClosed()){
                // SQL-запит для отримання даних з таблиці CHECKINOUTINFO та їх відображення в таблиці
    ...
    // Метод для додавання кнопки завантаження чека в кожному рядку таблиці
